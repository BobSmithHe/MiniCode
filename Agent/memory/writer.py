"""Memory writer — persist, extract, and consolidate cross-session knowledge.

Storage: .memory/*.md files with YAML frontmatter + MEMORY.md index.
...
from ..infra.config import WORKDIR, MEMORY_DIR, MEMORY_INDEX, client, MODEL
